...
extern value HalInit                 (void);
extern value HalDeInit               (void);
extern value HalMspInit              (void);
extern value HalMspDeInit            (void);
extern value HalInitTick             (int TickPriority);
extern value HalIncTick              (void);
extern value HalDelay                (int Delay);
extern value HalSuspendTick          (void);
extern value HalResumeTick           (void);
extern value HalGetTick              (void);
extern value HalGetHalVersion        (void);
extern value HalGetREVID             (void);
extern value HalGetDEVID             (void);
extern value HalEnableDBGSleepMode   (void);
extern value HalDisableDBGSleepMode  (void);
extern value HalEnableDBGStopMode    (void);
extern value HalDisableDBGStopMode   (void);
extern value HalEnableDBGStandbyMode (void);
extern value HalDisableDBGStandbyMode(void);
extern value BspGetVersion           (void);
extern value BspLedInit              (int Led);
extern value BspLedOn                (int Led);
extern value BspLedOff               (int Led);
extern value BspLedToggle            (int Led);
extern value BspPbInit               (int Button, int ButtonMode);
extern value BspPbGetState           (int Button);
c_primitive caml_builtin_cprim[] = {
  ...
  HalGetREVID,             
  HalGetDEVID,             
  HalEnableDBGSleepMode,   
  HalDisableDBGSleepMode,  
  HalEnableDBGStopMode,    
  HalDisableDBGStopMode,   
  HalEnableDBGStandbyMode, 
